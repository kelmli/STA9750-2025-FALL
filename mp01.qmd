...
This project explores Netflix’s global viewing trends through data analysis and visualization using R and its associated packages. By examining datasets on Netflix’s Top 10 films and TV shows across countries and time, we uncover patterns in viewership, content performance, and regional preferences. Using tools such as tidyverse and DT, we conduct exploratory data analysis (EDA) to highlight insights like the worldwide success of Stranger Things, the rapid rise of Netflix’s market in India, and the recent global phenomenon of KPop Demon Hunters. Through these analyses, we aim to understand how Netflix’s diverse catalog and international reach contribute to its sustained growth and cultural influence across markets.
